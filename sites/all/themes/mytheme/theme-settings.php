...
include_once dirname(dirname(__FILE__)) . '/bootstrap/theme-settings.php';
...
function mytheme_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['general']['container']['bootstrap_container_class'] = array(
    '#type' => 'select',
    '#title' => t('Container class'),
    '#default_value' => bootstrap_setting('container_class', $theme),
    '#empty_option' => t('None'),
    '#options' => array(
      'container-fluid' => t('Fluid (.container-fluid)'),
      'container' => t('Container (.container)')
    ),
    '#description' => t('Additional class .main-container. See <a href="!url">Fluid container</a>', array(
