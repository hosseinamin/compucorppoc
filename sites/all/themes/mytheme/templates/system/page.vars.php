...
function mytheme_preprocess_page(array &$variables) {
  ...
  if (!empty($variables['page']['sidebar_first']) && !empty($variables['page']['sidebar_second'])) {
    $variables['content_column_class'] = ' class="content-section with-first-sidebar"';
  }
  elseif (!empty($variables['page']['sidebar_first']) || !empty($variables['page']['sidebar_second'])) {
    $variables['content_column_class'] = ' class="content-section with-both-sidebar"';
  }
  else {
    $variables['content_column_class'] = ' class="content-section"';
  }
  */
  $variables['content_column_class'] = ' class="content-section"';
  $cclass = bootstrap_setting('container_class');
  switch($cclass) {
    case 'container-fluid':
    case 'container':
      $variables['container_class'] = $cclass;
      break;
    default:
      $variables['container_class'] = 'full-container';
  }
 ...
 */
function mytheme_process_page(array &$variables) {
